/**
 * @fileoverview Renderer for the status dialog: an auto-refreshing (5s)
 * dashboard of printer info, WebUI server state, camera proxy state, and
 * app health metrics such as uptime and memory. Meant for diagnostics and
 * support.
 */
