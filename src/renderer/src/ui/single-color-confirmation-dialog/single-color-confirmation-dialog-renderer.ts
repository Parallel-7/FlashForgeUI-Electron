/**
 * @fileoverview Renderer for the single-color confirmation dialog: shows the
 * active material-station slot's type and color before a single-color print
 * starts, blocks the start while the slot is empty or the station is
 * offline, and collects the optional bed-leveling preference. Targets
 * printers with a material station (AD5X, Creator 5 / 5 Pro).
 */
