/**
 * @fileoverview CoreWindowFactory creates the primary application windows:
 * settings, status, log dialog, about, and calibration. Each is a modal child
 * of the main window, single-instance (creating one while it is open focuses
 * it), and registered with WindowManager for cleanup on close.
 */
