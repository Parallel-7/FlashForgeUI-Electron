/**
 * @fileoverview The app's structured error type. AppError extends Error with
 * an ErrorCode, a context record, a timestamp, and the wrapped original
 * error, and it serializes with toJSON() for IPC and logging. Factories
 * (fromZodError, networkError, printerError, ...) build them; isAppError and
 * toAppError guard and convert; createErrorResult formats IPC responses.
 */
