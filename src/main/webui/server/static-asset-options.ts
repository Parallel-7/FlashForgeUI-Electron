 ...
 *
 * Exposes the header map, header-applier, and Express static options factory used
 * by `WebUIManager` so the desktop-hosted WebUI always serves fresh asset bundles
 * instead of stale cached files.
 */
